...
import cn.tannn.demo.jdevelops.frameworksweb.controller.pojo.Login;
...
public class LoginController {
    ...
    public ResultVO<Object> login(@RequestBody @Valid Login login) {
        // 第一步 先验证
        ...
        try {
            ...
            RedisSignEntity<String> redisSignEntity = new RedisSignEntity<>(
                    login.getUsername(),
                    login.getPlatform(),
                    false,
                    login.isOnlyOnline(),
