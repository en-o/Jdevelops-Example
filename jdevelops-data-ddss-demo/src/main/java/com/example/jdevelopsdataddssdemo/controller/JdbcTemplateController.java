...
public class JdbcTemplateController {
    ...
    @GetMapping("testDynamicDataSourceJdbcTemplateByDatabase")
    @DyDS
    public ResultVO<List<Map<String, Object>>> testDynamicDataSourceJdbcTemplateByDatabase(@DbName String dbName) {
        return ResultVO.success(jdbcTemplate.queryForList("select * from sys_user"));
    }


    @Operation(summary = "根据传入的数据源名查询-bean参")
    @PostMapping("testDynamicDataSourceJdbcTemplateByDatabaseBean")
    @DyDS
    public ResultVO<List<Map<String, Object>>> testDynamicDataSourceJdbcTemplateByDatabaseBean(@RequestBody @DbNamed TestVO dbName) {
        return ResultVO.success(jdbcTemplate.queryForList("select * from sys_user"));
    }
